...
<details> 
    <summary> **Learn better through videos? 🎞️** </summary>

    Watch our videos for PC and mobile here:
    
    <iframe class="yt_iframe" width="560" height="315" src="https://www.youtube-nocookie.com/embed/ToltKa0eLd0?si=oJAQ0ugoKUJ8zzdY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    <iframe class="yt_iframe" width="560" height="315" src="https://www.youtube-nocookie.com/embed/OR0L64Ga-rc?si=7EF7tfgGtHml6x8U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<Steps>
    ...
    2. Login with the `Sign in with Discord` button
        ...
        <details>
            ...
            Check out the
            [common issues](../common_issues#discord-says-you-need-to-verify-your-account-in-order-to-perform-this-action)
            page!
        </details>
    ...
    6. Authorize Bloxlink with your Roblox Account
        ...
        1. Make sure you are using the right Roblox account then click `Continue`
            ...
            <details>
                ...
                Head to the [common issues](../common_issues/#roblox-says-you-are-not-allowed-to-use-this-application)
    ...
    7. Select what servers you want to use this account in
        ...
        <details>
            <summary>I don't see the server I am looking for! 🤔</summary>

            This probably means you are accidentally using a different Discord account in your browser from
            what you normally use!

            Head to the [common issues](../common_issues#i-dont-see-the-server-im-looking-for-when-i-verify) page to
