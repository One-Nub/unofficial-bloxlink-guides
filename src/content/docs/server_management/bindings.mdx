...
<Tabs>
    <TabItem label="Group (Automatic)">
        ...
        ##### Making the bind
        See the ["Getting Started"](/server_management/getting_started/#connect-your-group) guide to create an 
    ...
    <TabItem label="Group (Manual)">
        ...
        <Steps>
            ...
            5. Select what is required to receive the role(s) you wish to give. <br />
                ...
                <br />
            6. Select your Discord role(s) to give, and group ranks if applicable.<br />
                There is also a button to have the bot create a new role - this is optional though.
            7. That's all! You can either click `Create new bind` to make some more binds, or click 
    ...
    <TabItem label="Item">
        ...
        <Steps>
            ...
            4. Select your Discord role(s) to give<br />
                Or, you can optionally have the bot make you a role with the "Create role" button.
            5. That's all! You can either click `Create new bind` to make some more binds, or click 
                `Publish` for the bot to save your binds.
