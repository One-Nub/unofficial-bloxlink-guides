    ...
    <TabItem label="Group (Manual)">
        ...
        <Steps>
            ...
            5. Select what is required to receive the role(s) you wish to give.
                ...
                Group ranks on Roblox are organized by IDs. This is why the options sound like they are for numbers. Higher
                ranks have a higher ID and lower ranks have a lower ID. People not in a group have a group rank of `0`.

                If you're not sure what to choose, the "Rank must match exactly" option is a good place to start!
